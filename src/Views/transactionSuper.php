...
session_start();
include "base.php";
include "../Controllers/transactionSuperController.php";

$transRepCtrl = new TransactionSuperController();
...
<body>
    ...
    <div class="cont">
        ...
        <div class="container contForm mx-auto bg-light p-5">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="branch" name="branch" class="form-select form-select-sm" style="height:2.5rem ;font-size:medium" required>
                            ...
                            <?php 
                            $branchs=$transRepCtrl->getBranchs();
                            var_dump($branchs);
        ...
        <?php $transRepCtrl->generateReport(); ?>
