    ...
    <main>
        <div class="card mx-auto" style="width: 50rem; height:27rem; margin: 0; position: absolute;top: 50%;left: 50%;-ms-transform: translate(-50%, -50%);transform: translate(-50%, -50%);">
            ...
            <div class="card-body" style="display: flex; flex-direction:column;">
                <h2 class="card-title mx-auto">Customer/Organization Added Successfully!</h2>
                ...
                <div class="mx-auto">
                    ...
                    <a href="employeeDashboard.php" class="btn btn-primary mx-auto" style="width:20vw">Return to the dashboard</a>
                </div>
            </div>
        </div>
    </main>
